<template>
  <div class="taskcreator" @click.stop="toggleAdd">
    <Row class="addtask"
	 v-show="!toggled"
	 main-axis="center"
	 cross-axis="center">
      <img src="@/assets/plus-circle-white.png">
      <span>Add Task</span>
    </Row>

    <div class="taskcard-expand" v-show="toggled">
      <div class="input">
	<div class="name">
	  <input ref="inputname" v-model="task.name"/>
	</div>
	...
	<Row>
	  ...
	  <button class="save" @click.stop="Save" :disabled="task.name.length == 0 || task.expect == 0"> Save </button>
	</Row>
      </Row>
...
<script lang="ts" setup>
 ...
 const task = ref({id: 0, name: '', isdone: false, finished: 0, expect: 1})
