...
<script lang="ts" setup>
 ...
 let text = inject('text') as Ref<string>
 let isdone = inject('isdone') as Ref<boolean>
 let expect = inject('expect') as Ref<number>
 let finished = inject('finished') as Ref<number>
 
 let inputText = ref<string>(text.value)
 let inputNumber = ref<number>(expect.value)
 ...
 function onsave() {
   ...
   expect.value = inputNumber.value
   emit('onclick', {
     'event': 'save',
   })
 }
